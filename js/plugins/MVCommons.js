...
/*:
 * @plugindesc 很棒的實用程序庫，提供常用和簡化的功能。
 ...
 *    Introduction
 * ==============================================================================
 * MVCommons (MVC) 插件是一個軟件開發工具包 (SDK)，
 * 旨在通過提供執行常見功能的標準方法來幫助插件製造商。
 * 該幫助文件將解釋所提供的功能及其用途。
 *
 * ==============================================================================
 *    The MVCommons module (Aliased as MVC)
 * ==============================================================================
 * MVCommons模塊是插件的主要部分，它提供了通用的函數，
 * 可以用來讓插件的編寫變得更加容易，同時保持與其他插件的兼容性，
 * 因為這些函數不需要重新定義。
 * ==============================================================================
 *    Stay Up To Date
 * ==============================================================================
 * 我們建議您定期檢查以確保 MVC 插件是最新的。
 * 插件更新將包括錯誤修復、代碼優化，當然還有新功能，因此強烈建議您使用最新版本。
 * 您可以訪問以下任意網址獲取最新版本；
