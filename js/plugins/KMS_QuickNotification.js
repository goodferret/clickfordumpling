...
//=============================================================================
// Added a new line of transparency code for personal use.
...
Params.displayGap           = parseIntWithDefault(pluginParams['Display gap'], 0);//16 personal use.
Params.displayOffsetX       = parseIntWithDefault(pluginParams['Display offset X'], 10);//-2
Params.displayOffsetY       = parseIntWithDefault(pluginParams['Display offset Y'], 10); //32
...
Window_QuickNotification.prototype.initialize = function()
{
    ...
    this.opacity         = 0;
	this.backOpacity = 220; //Added a new line of transparency code for personal use.
